...
public class Controller implements Initializable
{
    ...
    public void addEmployee(javafx.event.ActionEvent actionEvent){
        ...
        employ.firstName=firstNameTextField.getText();
        employ.lastName=lastNameTextField.getText();
        employeeListView.getItems().add(employ);
    }

    public void clearEmployee(javafx.event.ActionEvent actionEvent){
